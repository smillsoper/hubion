...
import type { HubionFlowDefinition } from '../types/designer'
...
export const flowsApi = {
  ...
  // Flow designer
  create: (name: string, flowType: string, definition: HubionFlowDefinition) =>
  ...
  updateDefinition: (id: string, definition: HubionFlowDefinition) =>
