    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-950">
      <div className="w-full max-w-sm bg-gray-900 rounded-2xl shadow-xl p-8">
        <div className="flex flex-col items-center mb-7">
          <img src="/hubion-favicon.svg" alt="Hubion" className="w-14 h-14 mb-3" />
          <h1 className="text-xl font-semibold text-white tracking-wide">Hubion</h1>
          <p className="text-gray-400 text-xs mt-0.5">Agent sign in</p>
        </div>
